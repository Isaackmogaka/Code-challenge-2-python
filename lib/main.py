...
if __name__ == "__main__":
    ...
    for review in Review.all():
        print(f"{review.customer().full_name()} reviewed {review.restaurant().name} with a rating of {review.get_rating()}")  

#python3 lib/main.py,,,,, python path to run the program
